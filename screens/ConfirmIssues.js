...
const ConfirmIssues = ({ navigation }) => {
  ...
  return (
    <View style={tw`flex-1 bg-THEME pt-status-bar`}>
      <View
        ...
        <Text style={tw`text-[18px] font-medium flex-1`}>
          Xác nhận thanh toán
        </Text>
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
          <Form ref={setFormRef} defaultValues={{}}>
            <View style={[styles.section]}>
              ...
              <View style={[styles.row, styles.productDetailItem]}>
                <Text style={[styles.detailLabel]}>Mã đơn thuốc QG</Text>
                <View style={{ flex: 1 }}>
                  <FormItem name="standard" style={styles.detailContent}>
                    <TextInput placeholder="Mã đơn thuốc QG" />
                  </FormItem>
                </View>
              </View>
