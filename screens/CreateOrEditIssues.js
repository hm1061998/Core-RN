...
let row = [];
let prevOpenedRow;
const CreateOrEditIssues = ({ navigation, route }) => {
    ...
    ({ item, index }, onClick) => {
      ...
      return (
        <Swipeable
          ...
          <Button
            onPress={() =>
              navigation.navigate('AddMedicineIssues', {
                dataEdit: item,
              })
            }
  ...
  return (
    <View style={tw`flex-1 bg-THEME pt-status-bar`}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Tạo phiếu bán thuốc</Text>
      ...
      <View style={styles.bodyPage}>
        <View style={styles.boxFilter}>
          <View style={styles.boxSearch}>
            ...
            />
            <Button
              onPress={() => navigation.navigate('ListMedicineWarehouse')}
              style={{
                flex: 1,
                height: verticalScale(30),
                justifyContent: 'center',
              }}>
              <Text style={styles.inputSearch}>Thêm thuốc vào phiếu</Text>
            </Button>
        ...
        <View style={styles.footer}>
          <TouchableOpacity
            ...
            onPress={() => {
              navigation.navigate('ConfirmIssues');
            }}>
            <View>
              <Text style={styles.footerTxt}>Tổng</Text>
              <View style={styles.tag}>
                <Text style={styles.tagTxt}>0</Text>
              </View>
            </View>
            <View style={{ flexDirection: 'row' }}>
              <Text style={styles.footerTxt}>{formatNumber(0)}</Text>
              <Icon
                type="FontAwesome"
                name="angle-right"
                size={scale(16)}
...
export default CreateOrEditIssues;
