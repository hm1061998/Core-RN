...
const FilterClinicReceipt = forwardRef(
  ({ defaultValues, value, onChange }, ref) => {
    ...
    console.log(tw`retina:h-screen`);
    console.log(tw`min-w-[25vw]`);
    // console.log({ size: SIZES.HEIGHT_WINDOW });
    // console.log({ size: SIZES.HEIGHT_SCREEN });
    ...
    return (
      <ScreenAnimModal
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Lọc phiếu nhập</Text>
        </View>
        <View style={styles.bodyPage}>
          ...
          <View style={tw`flex-row px-5 bg-WHITE shadow-lg py-5`}>
            <Button
              ...
              <Text style={tw`text-THEME font-medium retina:text-[16px]`}>
                Xóa bộ lọc
              </Text>
            </Button>
            <Button
              style={tw`flex-1 bg-THEME items-center justify-center rounded-lg py-3`}>
              <Text style={tw`text-WHITE font-medium retina:text-[16px]`}>
                Áp dụng
              </Text>
            </Button>
          </View>
...
export default FilterClinicReceipt;
