...
const PickerUnits = (
  { onChange, value, containerStyle, textStyle, data, placeholder },
  ref,
) => {
  ...
  return (
    <TouchableOpacity onPress={() => setVisible(true)} style={containerStyle}>
...
export default React.forwardRef(PickerUnits);
