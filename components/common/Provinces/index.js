...
const SelectProvinces = forwardRef(
  (
    { value, onChange, placeholder, placeholderStyle, style, disabled },
    ref,
  ) => {
      ...
      <>
        ...
        <ScreenAnimModal
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Chọn tỉnh/thành phố</Text>
          </View>
              ...
              <FlatList
                ...
                renderItem={({ item }) => (
                  <Button
                    ...
                    onPress={() => {
                      onChange?.({ id: item.id, name: item.provinceName });
                      modalRef.current?.close();
                    }}>
