...
import { groupMedicines } from '~/queryHooks';
...
const SelectGroupMedicines = forwardRef(
  (
    ...
    const {
      ...
      fetchNextPage,
      isFetchingNextPage,
    } = groupMedicines.useInfinitiData({
      pageSize: PAGE_SIZE,
      params: {
        filter: JSON.stringify(filter),
        sort: JSON.stringify(['name', 'ASC']),
      },
      key: ['groupMedicines', filter],
    });
      ...
      <>
        ...
        <ScreenAnimModal
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Chọn quy cách bào chế</Text>
...
export default SelectGroupMedicines;
